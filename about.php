...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Aku ada ide. Selama ini banyak toko yg menawarkan harga murah. Tapi kualitas meragukan.</p>
          ...
          <p class="Teks_Informasi">Dengan membeli baju di sini, otomatis anda tergolong menjadi orang kaya yg memiliki high taste terhadap baju berkualitas.</p>
          <p class="Teks_Informasi">Kami juga menawarkan promo belanja pergi umroh cuma disini Life Style Shop.</p>
          <p class="Teks_Informasi">Kami juga tidak menawarkan untuk memborong semua barang dagangan kami, karena barang kami kualitasnya tinggi, jadi kami sarankan anda mikir matang matang dulu sebelum membeli.</p>
          <p class="Teks_Informasi">Salam Toko mahal !!!</p></td>
      </tr>
    </table></th>
    <td width="200" align="left" valign="top" bgcolor="#E8EED7"><div class="Area_Menu_Kanan">
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">Rony Grayson Simanjuntak</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">123455329864 </td>
          </tr>
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">Rony Grayson Simanjuntak</td>
          </tr>
          ...
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">1456489575</td>
          </tr>
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">Rony Grayson Simanjuntak</td>
          </tr>
