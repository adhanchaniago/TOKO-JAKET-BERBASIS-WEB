...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Cara berbelanja di Life Style Shop sangat mudah. Bacalah petunjuk di bawah ini dan Anda siap untuk berbelanja :)</p>
          ...
          <p class="Teks_Informasi">Klik pada tombol beli pada item yang ingin Anda beli, jika Anda sudah selesai memilih barang, klik “check out” 
            Selanjutnya, Halaman terakhir adalah untuk pengecekan mengenai informasi no faktur dan total harga barang yang Anda beli. Order Anda telah kami terima. Tunggu konfirmasi dari kami.</p>
          ...
          <p class="Teks_Informasi">Life Style Shop</p>
